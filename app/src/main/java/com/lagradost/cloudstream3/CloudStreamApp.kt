...
class CloudStreamApp : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        // Hardcode Default Extension Repository (Megix Repo) on startup
        try {
            preloadDefaultRepository()
        } catch (e: Exception) {
            android.util.Log.e("PrimePlus", "Failed to preload default Megix Repository", e)
        }
    }
    ...
    private fun preloadDefaultRepository() {
        ...
        val currentRepos = getKey<Array<com.lagradost.cloudstream3.ui.settings.extensions.RepositoryData>>("PREBUILT_REPOSITORIES") ?: emptyArray()
